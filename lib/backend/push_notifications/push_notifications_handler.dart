...
final pageBuilderMap = <String, Future<Widget> Function(Map<String, dynamic>)>{
  ...
  'Registros_Animo': (data) async => NavBarPage(initialPage: 'Registros_Animo'),
  ...
  'RegistroHorarioComida': (data) async => RegistroHorarioComidaWidget(),
  'pdfTest': (data) async => PdfTestWidget(),
  'afkxd': (data) async => AfkxdWidget(),
};
