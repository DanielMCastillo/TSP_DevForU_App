...
class ContactoEmergencia2Widget extends StatefulWidget {
  const ContactoEmergencia2Widget({Key? key}) : super(key: key);

  @override
  _ContactoEmergencia2WidgetState createState() =>
      _ContactoEmergencia2WidgetState();
}

class _ContactoEmergencia2WidgetState extends State<ContactoEmergencia2Widget> {
