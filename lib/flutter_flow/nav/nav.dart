...
class AppStateNotifier extends ChangeNotifier {
  DeviiFirebaseUser? initialUser;
  DeviiFirebaseUser? user;
  ...
  void update(DeviiFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'listaRegistros',
              requireAuth: true,
              builder: (context, params) => ListaRegistrosWidget(),
            ),
            FFRoute(
              name: 'metas',
              path: 'metas',
            ...
            FFRoute(
              ...
              path: 'meditacion',
              requireAuth: true,
              builder: (context, params) => MeditacionWidget(),
            ),
            FFRoute(
              name: 'personaFeli',
              path: 'personaFeli',
              requireAuth: true,
              builder: (context, params) => PersonaFeliWidget(),
            ),
            FFRoute(
              name: 'tomarAgua',
              path: 'tomarAgua',
              requireAuth: true,
              builder: (context, params) => TomarAguaWidget(),
            ),
            FFRoute(
              name: 'formComida',
              path: 'formComida',
              requireAuth: true,
              builder: (context, params) => FormComidaWidget(),
            ),
            FFRoute(
              name: 'reflexiones',
              path: 'reflexiones',
              requireAuth: true,
              builder: (context, params) => ReflexionesWidget(),
            ),
            FFRoute(
              name: 'actoAmabilidad',
              path: 'actoAmabilidad',
              requireAuth: true,
              builder: (context, params) => ActoAmabilidadWidget(),
            ),
            FFRoute(
              name: 'vozInterna',
              path: 'vozInterna',
              requireAuth: true,
              builder: (context, params) => VozInternaWidget(),
            ),
            FFRoute(
              name: 'acercaDe',
              path: 'acercaDe',
